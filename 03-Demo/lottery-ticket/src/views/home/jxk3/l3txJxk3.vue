  ...
  <div id="l3txJxk3">
    <section class="g-bet-box">
      <div class="m-bet-box">
        ...
        <h5 class="tal">
          <span class="red-circle fl"></span><span class="h5-txt">任意开出以下号码即中<span class="red">10</span>元</span>
        ...
        <div class="balls mt10 mb">
          <em class="white-rectangle red" v-for="(item, index) in balls" :key="index" :class="{selected:item.isSelected}" @click="balls_select(item, index)"><span class="tac">三连号通选<br>(123,234,345,456)</span><mark>25</mark></em>
        </div>
      </div>
    </section>
...
export default {
  ...
  methods: {
    init: function () {
      // 初始化
      let balls = []
      balls.push({num: 'abc', isSelected: false})
