  ...
  <div id="t2fxJxk3">
    <section class="g-bet-box">
      <div class="m-bet-box">
        ...
        <h5 class="tar">
          <span class="red-circle fl"></span><span class="tal fl h5-txt">猜中开奖中相同的<span class="red">2</span>个号即中<span class="red">15</span>元</span>
        ...
        <div class="balls mt10 mb">
          <em class="white-rectangle red" v-for="(item, index) in balls" :key="index" :class="{selected:item.isSelected}" @click="balls_select(item, index)"><span>{{item.num}},{{item.num}},*</span><mark>25</mark></em>
        </div>
      </div>
    </section>
...
export default {
  ...
  methods: {
    ...
    Coms: function () {
      // 普通投注号
      this.ante_code = this.balls_selected
    },
    unique: function (arr) {
      const seen = new Map()
