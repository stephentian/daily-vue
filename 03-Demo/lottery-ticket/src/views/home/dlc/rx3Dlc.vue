  ...
  <div id="rx3Dlc">
    <section class="g-bet-box">
      <div class="m-bet-box">
        ...
        <h5 class="tar">
          <span class="red-circle fl"></span><span class="tal fl h5-txt">至少选<span class="red">3</span>个号码，猜对任意<span class="red">3</span>个开奖号码即中<span class="red">19</span>元</span>
...
export default {
  ...
  methods: {
    ...
    three_select: function (item) {
      ...
      if (item.isSelected) {
        if (this.three_selected.length < 11) {
    ...
    submitFail () {
      this.$refs.bTips.bottompopTips('至少选择3个号码')
    },
    submit: function () {
