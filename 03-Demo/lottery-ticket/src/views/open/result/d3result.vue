<template lang="html">
  <div id="d3result">
    <header class="m-top g-top-open">
      <h2 class="m-top-title tac"><i class="iconfont icon-arrow-left mr10" @click="routerBack"></i><span>福彩3D开奖结果</span></h2>
    </header>
    <div class="header-top-space"></div>
    <!-- <section class="g-top-tips">
      <div class="m-top-tips">
        <p class="tac">每天一期，21:15开奖</p>
      </div>
    </section> -->
    ...
    <footer class="m-footer">
      <router-link tag="button" class="m-footer-btn bgColor" to="/3d">去投注</router-link>
    </footer>
  </div>
</template>
...
export default {
  ...
  created () {
    this.$store.dispatch('getPeriodInfos', {name: '3d'})
  },
  computed: {
    ...mapState({
