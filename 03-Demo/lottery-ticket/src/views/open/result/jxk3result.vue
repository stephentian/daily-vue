<template lang="html">
  <div id="jxk3result">
    <header class="m-top g-top-open">
      <h2 class="m-top-title tac"><i class="iconfont icon-arrow-left mr10" @click="routerBack"></i><span>江西新快3开奖结果</span></h2>
    </header>
    ...
    <footer class="m-footer">
      <router-link tag="button" class="m-footer-btn bgColor" to="/JXK3">去投注</router-link>
    </footer>
  </div>
</template>
...
export default {
  ...
  created () {
    this.$store.dispatch('getPeriodInfos', {name: 'JXK3'})
  },
  computed: {
    ...mapState({
