  ...
  <div>
    ...
    <section class="g-detail-betchase mt15">
      <aside class="m-detail-betchase">
        ...
        <router-link tag="div" class="m-detail-betchase-list" v-for="(ticket, index) in chase_info" :key="index" :to="{ path: '/dlcdetail', query: { order_id: ticket.order_id }}">
    ...
    <router-link  class="m-footer box-shadow" tag="footer" :to="{ name: 'dlc'}">
